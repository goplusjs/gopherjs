...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 2, 14, 14, 1, 29, 334121078, time.UTC),
		},
		"/js": &vfsgen۰DirInfo{
			name:    "js",
			modTime: time.Date(2020, 1, 24, 9, 22, 40, 631101120, time.UTC),
		},
		"/js/js.go": &vfsgen۰CompressedFileInfo{
			name:             "js.go",
			modTime:          time.Date(2020, 1, 24, 9, 22, 40, 631294825, time.UTC),
		...
		"/nosync": &vfsgen۰DirInfo{
			name:    "nosync",
			modTime: time.Date(2020, 1, 24, 9, 22, 40, 633147255, time.UTC),
		},
		"/nosync/map.go": &vfsgen۰CompressedFileInfo{
			name:             "map.go",
			modTime:          time.Date(2020, 1, 24, 9, 22, 40, 632477496, time.UTC),
		...
		"/nosync/mutex.go": &vfsgen۰CompressedFileInfo{
			name:             "mutex.go",
			modTime:          time.Date(2020, 1, 24, 9, 22, 40, 632756188, time.UTC),
		...
		"/nosync/once.go": &vfsgen۰CompressedFileInfo{
			name:             "once.go",
			modTime:          time.Date(2020, 1, 24, 9, 22, 40, 633001188, time.UTC),
		...
		"/nosync/pool.go": &vfsgen۰CompressedFileInfo{
			name:             "pool.go",
			modTime:          time.Date(2020, 1, 24, 9, 22, 40, 633246887, time.UTC),
